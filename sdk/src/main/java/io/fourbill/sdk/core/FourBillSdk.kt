package io.fourbill.sdk.core

import io.fourbill.sdk.data.model.*
import io.fourbill.sdk.data.network.responses.*
import io.fourbill.sdk.data.network.security.AuthEncryption
import io.fourbill.sdk.manager.HostPaymentsManager
import io.fourbill.sdk.manager.WebPaymentsManager
import io.fourbill.sdk.util.getPostData

class FourBillSdk(authPoin: Int, apiToken: String, authKey: Long, accountId: Int, walletId: Int) {

    private val TAG = FourBillSdk::class.simpleName
