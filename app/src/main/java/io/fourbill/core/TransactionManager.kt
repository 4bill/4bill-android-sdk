package io.fourbill.core

import io.fourbill.sdk.core.FourBillSdk
...
object TransactionManager {
    ...
    private const val SERVICE_ID_WEB: Int  = //Enter your data
    private const val SERVICE_ID_WEB_WITH_TOKEN: Int  = //Enter your data
    private const val SERVICE_ID_TOKEN: Int  = //Enter your data
    private const val SERVICE_ID_HOST_TO_HOST: Int  = //Enter your data


    //Test temp url for callback
    const val TEMP_URL_FOR_CALLBACK:String  = //Enter your data

    val sdk: FourBillSdk = FourBillSdk(AUTH_POINT, API_TOKEN, AUTH_KEY, ACCOUNT_ID, WALLET_ID)
}