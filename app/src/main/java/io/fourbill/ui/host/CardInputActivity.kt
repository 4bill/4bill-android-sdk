...
import io.fourbill.R
import io.fourbill.core.TransactionManager
import io.fourbill.core.TransactionManager.SERVICE_ID_HOST_TO_HOST
import io.fourbill.core.TransactionManager.TEMP_URL_FOR_CALLBACK
import io.fourbill.sdk.data.model.CardInputData
import io.fourbill.sdk.data.model.Fields
import io.fourbill.sdk.data.model.Result
import io.fourbill.sdk.data.network.responses.PayTransactionResponse.PayResponse
import io.fourbill.sdk.util.*
import io.fourbill.sdk.view.CardInputView
import io.fourbill.ui.web.WebActivity
import io.fourbill.util.getRandomNumber
import io.fourbill.util.showInputDialog
import io.fourbill.util.showProgressDialog
import io.fourbill.util.showToast
...
class CardInputActivity : AppCompatActivity(), CardInputView.CardInputListener {
    ...
    private fun generateData(){
        ...
        cardInputView.setTransactionLogo(R.drawable.fourbill_logo)
